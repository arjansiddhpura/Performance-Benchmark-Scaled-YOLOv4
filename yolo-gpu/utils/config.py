...
config.model.max_nlabels_p3 = (
    mask_n * len(config.model.anchors.p3width) * config.dataset.max_bbox_per_scale
)
config.model.max_nlabels_p4 = (
    mask_n * len(config.model.anchors.p3width) * config.dataset.max_bbox_per_scale
)
config.model.max_nlabels_p5 = (
    mask_n * len(config.model.anchors.p3width) * config.dataset.max_bbox_per_scale
)
